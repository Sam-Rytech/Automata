...
export function NavApp() {
  ...
  // Only restore session if user explicitly connected before
  useEffect(() => {
    if (typeof window === "undefined" || !window.ethereum) return;
    const hasConnectedBefore = sessionStorage.getItem("automata_connected");
  ...
  const connect = async () => {
    ...
    try {
      ...
      sessionStorage.setItem("automata_connected", "true");
...
//   const disconnect = () => setAddress(null);
  const disconnect = () => {
  setAddress(null)
  sessionStorage.removeItem('automata_connected')  
}
