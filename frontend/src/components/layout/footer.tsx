    ...
    >
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', lineHeight: 1.6 }}>
            ...
            <br />
            <span style={{ fontSize: '0.72rem', opacity: 0.6 }}>A Polkadot Hackathon Project</span>
          </p>
        </div>

        {/* Right — subscribe */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.75rem' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.72rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Stay updated
          </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            {/* Skeuomorphic subscribe button */}
            <button
              className="skeuo-btn skeuo-btn-sm"
              onClick={() => {
                if (open && email.trim()) handleSubmit()
                else setOpen(o => !o)
              }}
      ...
      <div style={{
        ...
        <p style={{ color: 'rgba(255,255,255,0.2)', fontSize: '0.72rem' }}>
          XCM v3 · Moonbeam · Polkadot · {new Date().getFullYear()}
        </p>
      </div>
    </footer>
  )
